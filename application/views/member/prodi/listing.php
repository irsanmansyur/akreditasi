				...
				<tbody>
					...
					foreach ($listing as $listing) { ?>
						<tr>
							...
							<td>
								<?php if ($listing->sertifikat == "") : ?>
									<a href="#tidakadasertifikat" class="badge badge-primary">Tidak tersedia </a>
								<?php else : ?>
									<a href="<?php echo base_url() ?>uploads/sertifikat/<?php echo $listing->sertifikat ?>">Sertifikat </a>
								<?php endif; ?>
							</td>
