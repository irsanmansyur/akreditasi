...
class M_prodi extends CI_Model
{
	...
	{
		$this->db->select('tbl_prodi.*,tbl_jenjang.jenjang_nama,tbl_fakultas.fakultas_nama');
		$this->db->from('tbl_prodi');
		$this->db->join('tbl_jenjang', 'tbl_jenjang.jenjang_id = tbl_prodi.id_subjenjang', 'LEFT');
